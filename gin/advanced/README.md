...
### Gin server
Gin server general configuration.
...
#### logging
Logging middleware will use log instance from **gin.logger.zapLogger.ref** and **gin.logger.eventLogger.ref**.
...
#### Metrics prometheus
**gin.prom** must be enabled in order to use it.
