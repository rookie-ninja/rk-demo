# Demo
Rk style golang server package with fiber entry enabled.
...
## Install tools
In order to generate swagger for fiber API, we are using [swag](https://github.com/swaggo/swag) command line tool.
...
## boot.yaml
Since we are using fiber framework, please refer [rk-fiber](https://github.com/rookie-ninja/rk-fiber) for details.
